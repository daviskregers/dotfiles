...
local mappings = {
    ...
    E = { ":lua require('nvim-projectconfig').edit_project_config()<cr>", "Edit project config" },
    ...
    s = {
        ...
        x = {
            ...
            a = {
                ":SReplaceAll",
                "Search and replace all including ignored files",
            },
            R = {
                ":SReplaceAndSave",
                "Search, replace and save",
            },
            A = {
                ":SReplaceAllAndSave",
                "Search, replace and save including ignored files"
            }
        }
    },
