...
- Multi-part choices → separate `AskUserQuestion` questions (forces a per-item pick), never a free-text "want me to do X and Y?".
...
The `approval-scope` hook flags bare approvals.
