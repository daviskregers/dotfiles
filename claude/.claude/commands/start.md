...
6. **Only once every claim checks out**, the agent implements — sketching the slices and their rough churn first, flagging any over ~250 lines. (If what-to-build is itself unsettled, `grilling` first.)
