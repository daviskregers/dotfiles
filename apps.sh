...
pulseaudio-alsa pavucontrol ctags xcompmgr libreoffice aws-cli wireshark-qt jdk-openjdk gnutls lib32-gnutls telegram-desktop jupyter-notebook terminator nettle dbeaver
