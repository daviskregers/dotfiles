...
var Tools = []spec.Tool{
	...
	},
	{
		...
		Args:        []spec.ToolArg{{Name: "content", Type: spec.ArgString, Describe: "Full review markdown content"}},
	...
	},
	{
		...
		Args: []spec.ToolArg{
			{Name: "content", Type: spec.ArgString, Describe: "Full HTML content"},
			{Name: "title", Type: spec.ArgString, Optional: true, Describe: "Short slug for filename (e.g. 'jwt-auth-flow')"},
		},
	...
	},
	{
		...
		Args: []spec.ToolArg{
			...
			{Name: "title", Type: spec.ArgString, Optional: true, Describe: "New PR title (omit to leave unchanged)"},
			{Name: "body", Type: spec.ArgString, Optional: true, Describe: "New PR body/description in markdown (omit to leave unchanged)"},
		},
	...
	},
	{
		...
		Args:        []spec.ToolArg{{Name: "prUrl", Type: spec.ArgString, Describe: "Full GitHub PR URL (https://github.com/owner/repo/pull/N)"}},
	...
	},
	{
		...
		Args: []spec.ToolArg{
			{Name: "prUrl", Type: spec.ArgString, Describe: "Full GitHub PR URL"},
			{Name: "timeoutSec", Type: spec.ArgNumber, Optional: true, Describe: "Max seconds to wait (default 180)"},
			{Name: "pollSec", Type: spec.ArgNumber, Optional: true, Describe: "Seconds between polls (default 10)"},
		},
